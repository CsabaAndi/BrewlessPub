...
export function PythonIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://www.python.org/" title="Python">
            {(size) => (
...
{/* License - https://icons8.com */ }
export function ReactIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://react.dev/" title="React">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
...
{/* License - https://icons8.com */ }
export function TailwindIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://tailwindcss.com/" title="Tailwind CSS">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
...
{/* License - https://icons8.com */ }
export function JavaScriptIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} title="JavaScript">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
...
{/* License - https://icons8.com */ }
export function TypeScriptIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://www.typescriptlang.org/" title="TypeScript">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
                    ...
                    <path fill="#fff" d="M39.194,26.084c0,0-1.787-1.192-3.807-1.192s-2.747,0.96-2.747,1.986c0,2.648,7.381,2.383,7.381,7.712c0,8.209-11.254,4.568-11.254,4.568V35.22c0,0,2.152,1.622,4.733,1.622s2.483-1.688,2.483-1.92c0-2.449-7.315-2.449-7.315-7.878c0-7.381,10.658-4.469,10.658-4.469L39.194,26.084z" />
                </svg>
            )}
        </ResponsiveIcon>
    );
...
{/* License - https://icons8.com */ }
export function JavaIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://dev.java/" title="Java">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
...
{/* License - https://icons8.com */ }
export function DockerIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://www.docker.com/" title="Docker">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
                    <path fill="#2395ec" d="M47.527,19.847c-0.13-0.102-1.345-1.007-3.908-1.007c-0.677,0.003-1.352,0.06-2.019,0.171c-0.496-3.354-3.219-4.93-3.345-5.003l-0.688-0.392l-0.453,0.644c-0.567,0.866-1.068,1.76-1.311,2.763c-0.459,1.915-0.18,3.713,0.806,5.25C35.417,22.928,33.386,22.986,33,23H1.582c-0.826,0.001-1.496,0.66-1.501,1.474c-0.037,2.733,0.353,5.553,1.306,8.119c1.089,2.818,2.71,4.894,4.818,6.164C8.567,40.184,12.405,41,16.756,41c1.965,0.006,3.927-0.169,5.859-0.524c2.686-0.487,5.271-1.413,7.647-2.74c1.958-1.119,3.72-2.542,5.219-4.215c2.505-2.798,3.997-5.913,5.107-8.682c0.149,0,0.298,0,0.442,0c2.743,0,4.429-1.083,5.359-1.99c0.618-0.579,1.101-1.284,1.414-2.065L48,20.216L47.527,19.847z" />
                    <path fill="#2395ec" d="M8,22H5c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C9,21.552,8.552,22,8,22z" />
                    <path fill="#2395ec" d="M14,22h-3c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C15,21.552,14.552,22,14,22z" />
                    <path fill="#2395ec" d="M20,22h-3c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C21,21.552,20.552,22,20,22z" />
                    <path fill="#2395ec" d="M26,22h-3c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C27,21.552,26.552,22,26,22z" />
                    <path fill="#2395ec" d="M14,16h-3c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C15,15.552,14.552,16,14,16z" />
                    <path fill="#2395ec" d="M20,16h-3c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C21,15.552,20.552,16,20,16z" />
                    <path fill="#2395ec" d="M26,16h-3c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C27,15.552,26.552,16,26,16z" />
                    <path fill="#2395ec" d="M26,10h-3c-0.552,0-1-0.448-1-1V6c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C27,9.552,26.552,10,26,10z" />
                    <path fill="#2395ec" d="M32,22h-3c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h3c0.552,0,1,0.448,1,1v3C33,21.552,32.552,22,32,22z" />
                </svg>
            )}
        </ResponsiveIcon>
    );
...
{/* License - https://icons8.com */ }
export function PandasIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://pandas.pydata.org/" title="Pandas">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
...
{/* License - https://icons8.com */ }
export function NumpyIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://numpy.org/" title="NumPy">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 48 48">
                    ...
                    <path fill="#448aff" d="M22.71,23.637l-5.384-2.708v11.699c0,0-6.586-14.012-7.195-15.27c-0.079-0.163-0.401-0.341-0.484-0.385C8.46,16.353,5,14.601,5,14.601v20.676l4.787,2.566V27.031c0,0,6.515,12.52,6.582,12.657s0.718,1.455,1.418,1.919c0.929,0.618,4.919,3.016,4.919,3.016L22.71,23.637z" />
                </svg>
            )}
        </ResponsiveIcon>
    );
...
export function TensorFlowIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://www.tensorflow.org/" title="TensorFlow">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 256 274">
                    <path fill="#e55b2d" d="M145.726 42.065v42.07l72.861 42.07v-42.07zM0 84.135v42.07l36.43 21.03V105.17zm109.291 21.035l-36.43 21.034v126.2l36.43 21.035v-84.135l36.435 21.035v-42.07l-36.435-21.034z" />
                    <path fill="#ed8e24" d="M145.726 42.065L36.43 105.17v42.065l72.861-42.065v42.065l36.435-21.03zM255.022 63.1l-36.435 21.035v42.07l36.435-21.035zm-72.865 84.135l-36.43 21.035v42.07l36.43-21.036zm-36.43 63.104l-36.436-21.035v84.135l36.435-21.035z" />
                    <path fill="#f8bf3c" d="M145.726 0L0 84.135l36.43 21.035l109.296-63.105l72.861 42.07L255.022 63.1zm0 126.204l-36.435 21.03l36.435 21.036l36.43-21.035z" />
                </svg>
            )}
        </ResponsiveIcon>
    );
...
{/*https://iconify.design | by: Gil Barbara License: CC0 */ }
export function PlayWrightIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://playwright.dev" title="Playwright">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 256 192">
...
{/*License - https://iconscout.com/free-icon/angular-3 | by: Icon Mafia */ }
export function AngularIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://angular.io/" title="Angular">
            {(size) => (
                <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 256 272">
                    <path fill="#E23237" d="M.1 45.522L125.908.697l129.196 44.028-20.919 166.45-108.277 59.966-106.583-59.169L.1 45.522z" />
                    <path fill="#B52E31" d="M255.104 44.725L125.908.697v270.444l108.277-59.866 20.919-166.55z" />
                    <path fill="#FFF" d="M126.107 32.274L47.714 206.693l29.285-.498 15.739-39.347h70.325l17.233 39.845 27.99.498-82.179-174.917zm.2 55.882l26.496 55.383h-49.806l23.31-55.383z" />
                </svg>
            )}
        </ResponsiveIcon>
    );
...
{/*License - https://iconscout.com/free-icon/node-js-3 | by: Icon Mafia */ }
export function NodeJsIcon({ size_min, size_standard }: IconSizeProps) {
    return (
        <ResponsiveIcon size_min={size_min} size_standard={size_standard} link="https://nodejs.org/en" title="Node.js">
            {(size) => (
