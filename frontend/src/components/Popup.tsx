            ...
            >
                <div className='flex items-start justify-between gap-x-4 mb-4'>
                    <div className='flex items-center'>
                        <span className='flex shrink-0 items-center justify-center w-9 h-9 rounded-full'>
                        ...
                        <h2 className='text-base sm:text-lg font-extrabold tracking-tight text-stone-200 leading-none -mt-1'>
                            <span className='text-color-main'>Imp</span>
                            ortant
                        </h2>
                    </div>
                ...
                <div className='flex items-center justify-between gap-x-4'>
                    <span className='text-xs text-stone-500'>
                        {translate('popup.lastUpdatedLabel')}: {translate('popup.lastUpdatedDate')}
                    </span>
                    <button
                        onClick={handleClose}
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            strokeWidth="2" stroke="currentColor" className="w-4 h-4 text-color-main">
